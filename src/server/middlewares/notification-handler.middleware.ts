...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'task_assigned.update': {
    roles: ['owner', 'administrator', 'client-manager', 'team-member'],
    key: 'task',
    tenantPath: [],
    userPath: [],
  },
  'client_status_updated.update': {
    roles: ['owner', 'administrator', 'client-manager'],
    key: 'client',
    tenantPath: [],
    userPath: [],
...
const tenantRoles: string[] = ['owner', 'administrator', 'client-manager', 'team-member'];
