...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`ProSysFlow`}</title>

        <meta
          name="description"
          content="Welcome to ProSysFlow - Pioneers of tomorrow's solutions today, constantly evolving to craft innovative tech solutions that streamline your processes, automate the mundane and help your business dominate in the digital world."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1671726203454-5d7a5370a9f4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHx0ZWNobm9sb2d5fGVufDB8fHx8MTY5NTU4NTQyNHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to ProSysFlow - Pioneers of tomorrow's solutions today, constantly evolving to craft innovative tech solutions that streamline your processes, automate the mundane and help your business dominate in the digital world.`}
            </Text>
            <Box
